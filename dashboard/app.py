...
def reactive_calc_combined():
    ...
    temp = round(random.uniform(65, 77), 1)
...
ui.page_opts(
    title="PyShiny Express: Desiree's Live Data Example", 
    fillable=True
)

# Add the CSS styling directly within the HTML content
ui.HTML("""
<style>
    body {
...
with ui.sidebar(open="open", style="background-color: #f2f2f2;"):
    ui.h2("Kansas City Weather", class_="text-center")
    ui.p(
        "A demonstration of real-time temperature readings in Kansas City, MO.",
        class_="text-center",
    )
    ui.hr()
    ui.h6("Links:")
    ui.a(
        "GitHub Source",
        href="https://github.com/dblake26/cintel-05-cintel",
        target="_blank",
    )
    ui.a(
        "GitHub App",
...
with ui.layout_columns():
    ...
    with ui.card(full_screen=True):
        ui.card_header("Current Date and Time", style="background-color: lavender;")
...
with ui.card(full_screen=True):
    ui.card_header("Most Recent Readings", style="background-color: lavender;")
...
with ui.card():
    ui.card_header("Chart with Current Trend", style="background-color: lavender;")
